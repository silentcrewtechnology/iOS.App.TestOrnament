# iOS. App. Test Ornament



## Getting started

This sample app now lives on GitHub. Use the commands below to connect your local checkout and push it to the new remote.
...
```
cd existing_repo
git remote add origin https://github.com/silentcrewtechnology/iOS.App.TestOrnament.git
git branch -M main
...
- [ ] [Configure webhooks](https://docs.github.com/en/webhooks-and-events/webhooks/creating-webhooks)
